...
public class MySessionTask2 extends KhandroidAsyncTask<Void, Void, String> {
    private HttpFunctionality mHttpFunc;

    public MySessionTask2(HttpFunctionality httpFunc) {
        if (httpFunc != null) {
            mHttpFunc = httpFunc;
        } else {
    ...
    protected String doInBackground(Void... params) {
        ...
        GetRequestBuilder b = new GetRequestBuilder(AppConstants.HOST + AppConstants.PAGE_SESSION2);
